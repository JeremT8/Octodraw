<template>
    <div class="content-all">
        <div class="content-carrousel">
            <figure><img src="../assets/images/amateur_octodraw.svg"></figure>
            <figure><img src="../assets/images/amateur_octodraw.svg"></figure>
            <figure><img src="../assets/images/amateur_octodraw.svg"></figure>
            <figure><img src="../assets/images/amateur_octodraw.svg"></figure>
            <figure><img src="../assets/images/amateur_octodraw.svg"></figure>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                else{ angle = angle - 60}spinner.setAttribute("style","transform:rotateY("+ angle +"deg);")
            }
        }
    }
</script>
...
body{
    background-image: url(../assets/images/amateur_octodraw.svg);
